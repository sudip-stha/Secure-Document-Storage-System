...
const NotificationModal = () => {
  ...
  return (
    <div
      className="bg-overlay-surface min-h-dvh flex flex-col gap-45 p-8"
    ...
    >
      ...
      <div className="flex flex-col gap-4 items-center">
        <div className="bg-authorisation-locked-border flex justify-center items-center rounded-full p-4">
          <svg
            width="24"
            height="24"
            viewBox="0 0 10 10"
        ...
        <div className="flex flex-col gap-2 items-center">
          ...
          <span className="font-dmsans font-medium text-[14px] text-text-tertiary">
